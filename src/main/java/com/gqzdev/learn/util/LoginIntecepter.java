...
public class LoginIntecepter implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
		...
		if (uri.endsWith("logon.html")||uri.endsWith("logon.jsp") || uri.endsWith("logon") || uri.endsWith("userLogon.html")  || uri.endsWith("css") || uri.endsWith("js")) {
			//访问登录页面时，直接访问
			return true; 
		}else if (object!=null) {
