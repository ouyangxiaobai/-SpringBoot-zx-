...
<body>
    ...
    <%--color: white;" class="login100-form-title p-b-49 loginTitle">自主学习平台系统</span>--%>
			<div style="position: relative;background: #4CAAED;
    box-shadow: #4caaed 1px 0px 30px 10px;
    opacity: 0.9;" class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<!-- 登录form -->
    ...
    color: white;" class="login100-form-title p-b-49 loginTitle">自主学习平台系统</span>
					<div style="border-bottom: 1px" class="wrap-input100 validate-input m-b-23" data-validate="请输入用户名" >
						<span style="color: white" class="label-input100">用户名：</span>
						<input style="display: inline;width: 82%;" class="input100"	type="text" name="account" placeholder="请输入用户名"	autocomplete="off" required="required">

					</div>

					<div style="border-bottom: 1px" class="wrap-input100 validate-input" data-validate="请输入密码">
						<span style="color: white"  class="label-input100">密码：</span>
						<input style="display: inline;width: 82%;margin-left: 14px;" class="input100" type="password" name="password" placeholder="请输入密码" required="required">

					</div>

					
					<div style="margin-top:10px; float:left;">
						<span style="color: white"  class="label-input100 label">角色：</span>
						<div class="role">
							<select name="role">
					...
					<div  style="margin-top:10px;float:left;width: 100%;">
						<span style="color: white"  class="label-input100">验证码：</span>
						<input type="text" name="verifyCode" placeholder="请输入验证码" required="required" style="width:238px;height: 50px;font-size: 16px;text-align: center;">
						<img id="verifyCode" alt="验证码" :src="imagSrc" @click="changeCheckCode()" style="float:right;margin-left: 150px;width: 70px;height: 50px;margin-left: 0px;"/>
					</div>
