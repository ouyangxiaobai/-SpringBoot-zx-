...
<html>
<head>
	<title>查询视频[教师上传]-自主学习平台ForFuture</title>
...
<body>
            ...
            <div class="panel panel-default wk-panel wk-table-tools-panel">
                ...
                <div class="panel-body panel-button">
	                ...
	                <c:choose>
						...
						<c:otherwise>
						 	<!--  若为教师有权限管理自己发布的视频    管理员则可以管理所有的视频 -->
	...
	<div class="row" id="courseVideoContainer" v-cloak>
		<div class="col-lg-12">
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						<tr v-for="(courseVideo,index) in courseVideoList" class="showStyle">
							<td>
								<input :id="'grid_'+(courseVideo.id)" name="workerRadio" type="radio" aria-label="选择" />
							</td>
							<td>{{index+1+(page-1)*pageSize}}</td>
							<td>{{courseVideo.path}}</td>
