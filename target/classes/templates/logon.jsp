...
<body>
	<div class="limiter" id="loginContainer">
		<div class="container-login100"
			...
			<div style="position: relative;left: 25%;" class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<!-- 登录form -->
				<form class="login100-form validate-form"
					...
					<div style="text-align:left;">
						<a href="javascript:void(0);" class="txt2" style="color:red;font-weight:700;font-size:14px;">提示：${info}</a>
					</div>
					<div class="container-login100-form-btn">
						...
						<a href="<%=basePath%>register.html" style="color: deepskyblue">注册</a>

					</div>
					<div class="copyright">
						<%--<a href="#" target="_blank"> ©2021 xxx 设计 </a></br>--%>
